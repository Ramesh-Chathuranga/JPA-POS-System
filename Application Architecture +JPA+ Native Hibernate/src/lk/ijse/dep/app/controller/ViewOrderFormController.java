...
public class ViewOrderFormController {
    ...
    public void  calCulateAllTotal(){
       tblOrderDetails.getItems().forEach(orderDetailTM -> {
           AllTotal+=orderDetailTM.getTotal();
           lblTotal.setText("Total : " + AllTotal);
       });
    ...
    public void fillData() {
        try {
            ...
            for (OrderDetailDTO orderDetailDTO : orderDetailDTOS) {
                ...
                AllTotal+=(orderDetailDTO.getQty() * orderDetailDTO.getUnitPrice() );
